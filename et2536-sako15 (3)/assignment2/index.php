...
$tbl = "CREATE TABLE IF NOT EXISTS sam2_devices ( 
...
$sqls = "INSERT IGNORE INTO sam2_devices (IP,PORT,COMMUNITY) VALUES (\"$x\", \"$y\", \"$z\")";
...
mysqli_select_db($conn,"$database");
    $sqlu = "UPDATE sam2_devices SET interfaces='$joined' WHERE IP=\"$r\" AND PORT =\"$t\" AND COMMUNITY=\"$y\"";
