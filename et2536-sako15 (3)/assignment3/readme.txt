...
traphandle 1.3.6.1.4.1.41717.10.* perl /var/www/html/et2536-sako15/assignment3/trapDaemon.pl
...
6) Open the Terminal and give the trap command :
 
{
 Command : sudo snmptrap -v 1 -c public 127.0.0.1:50162 .1.3.6.1.4.1.41717.10 10.2.3.4 6 247 '' .1.3.6.1.4.1.41717.10.1 s "" .1.3.6.1.4.1.41717.10.2 i 1

}
7). Open localhost/et2536-sako15/assignment3/index.php, where you can see the status of the device. 
